...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    "nav.projects": "설치사례",
    "nav.quote": "견적문의",
    "nav.groupPurchase": "공동구매", // 공동구매 메뉴 번역 추가
    ...
    "projects.backToList": "설치사례 목록으로",
    "projects.projectImages": "프로젝트 이미지",
    "projects.projectOverview": "프로젝트 개요",
    "projects.detailedContent": "상세 내용",
    "projects.notFound": "프로젝트를 찾을 수 없습니다",
    "projects.similarProject": "비슷한 프로젝트를 원하시나요?",
    "projects.ctaDescription": "전국 어디든 빠르게 시공, 재도테크가 함께합니다.",
    "projects.freeQuote": "무료 견적 문의",
    ...
    "quote.delete": "삭제",
    "quote.vatDisclaimer": "VAT 포함 / 배송비, 설치비 별도",
    "quote.currency": "원",
    ...
    "quote.level.8": "8단",
    "quote.level.9": "9단",
    "quote.type.standalone": "독립형",
    "quote.type.connected": "연결형",
    ...
    "groupPurchase.title": "경량랙 공동구매",
    "groupPurchase.subtitle": "함께 구매하고 더 저렴하게",
    "groupPurchase.description": "100% 국내산 철재, 견고하고 깨끗한 경량랙",
    "groupPurchase.subtitle2": "함께하면 더 저렴하게",
    "groupPurchase.createButton": "공동구매 생성하기",
    "groupPurchase.listTitle": "진행중인 공동구매",
    "groupPurchase.activeListTitle": "진행중인 공동구매",
    "groupPurchase.closedListTitle": "종료된 공동구매",
    "groupPurchase.noItems": "진행중인 공동구매가 없습니다",
    "groupPurchase.noClosedItems": "종료된 공동구매가 없습니다",
    "groupPurchase.participants": "참여자",
    "groupPurchase.deadline": "마감일",
    "groupPurchase.daysLeft": "일 남음",
    "groupPurchase.closed": "마감",
    "groupPurchase.joinButton": "참여하기",
    "groupPurchase.viewDetails": "자세히 보기",

    "groupPurchase.create.title": "공동구매 생성",
    "groupPurchase.create.subtitle": "위치를 입력하여 공동구매를 시작하세요",
    "groupPurchase.create.location": "위치",
    "groupPurchase.create.locationPlaceholder": "예: 부산 해운대",
    "groupPurchase.create.locationHelper": "공동구매 제목으로 사용됩니다",
    "groupPurchase.create.submit": "공동구매 생성하기",
    "groupPurchase.create.success": "공동구매가 생성되었습니다",
    // Added countdown timer translations for Korean
    "groupPurchase.timeRemaining": "남은 시간",
    "groupPurchase.days": "일",
    "groupPurchase.hours": "시간",
    "groupPurchase.minutes": "분",
    "groupPurchase.seconds": "초",

    "groupPurchase.detail.title": "공동구매 상세",
    "groupPurchase.detail.location": "위치", // Added location translation for detail page
    "groupPurchase.detail.selectOptions": "옵션 선택",
    "groupPurchase.detail.selectedItems": "선택한 항목",
    "groupPurchase.detail.addToCart": "추가하기",
    "groupPurchase.detail.remove": "제거",
    "groupPurchase.detail.personalInfo": "개인정보 입력",
    "groupPurchase.detail.name": "이름",
    "groupPurchase.detail.phone": "전화번호",
    "groupPurchase.detail.email": "이메일",
    "groupPurchase.detail.detailedAddress": "상세 주소",
    "groupPurchase.detail.addressPlaceholder": "배송 및 설치 주소를 입력하세요",
    "groupPurchase.detail.privacyAgree": "개인정보 제공 동의",
    "groupPurchase.detail.submitApplication": "신청하기",
    "groupPurchase.detail.applicationSuccess": "공동구매 신청이 완료되었습니다",
    "groupPurchase.detail.backToList": "목록으로",
    "groupPurchase.detail.cancel": "취소",
  ...
  en: {
    ...
    "nav.quote": "Quote",
    "nav.groupPurchase": "Group Purchase", // 공동구매 영어 번역
    ...
    "projects.backToList": "Back to Installation Cases",
    "projects.projectImages": "Project Images",
    "projects.projectOverview": "Project Overview",
    "projects.detailedContent": "Detailed Content",
    "projects.notFound": "Project Not Found",
    "projects.similarProject": "Want a similar project?",
    "projects.ctaDescription": "Fast installation anywhere in Korea, JAEDO TECH is with you.",
    "projects.freeQuote": "Free Quote Request",
    ...
    "quote.delete": "Delete",
    "quote.vatDisclaimer": "VAT Included / Shipping & Installation Separate",
    "quote.currency": "KRW",
    ...
    "quote.level.1": "1 Level",
    "quote.level.2": "2 Levels",
    "quote.level.3": "3 Levels",
    "quote.level.4": "4 Levels",
    "quote.level.5": "5 Levels",
    "quote.level.6": "6 Levels",
    "quote.level.7": "7 Levels",
    "quote.level.8": "8 Levels",
    "quote.level.9": "9 Levels",
    "quote.type.standalone": "Standalone",
    "quote.type.connected": "Connected",
    ...
    "groupPurchase.title": "Light Rack Group Purchase",
    "groupPurchase.subtitle": "Buy together and save more",
    "groupPurchase.description": "100% Korean steel, sturdy and clean light racks",
    "groupPurchase.subtitle2": "Better together, cheaper together",
    "groupPurchase.createButton": "Create Group Purchase",
    "groupPurchase.listTitle": "Active Group Purchases",
    "groupPurchase.activeListTitle": "Active Group Purchases",
    "groupPurchase.closedListTitle": "Closed Group Purchases",
    "groupPurchase.noItems": "No active group purchases",
    "groupPurchase.noClosedItems": "No closed group purchases",
    "groupPurchase.participants": "Participants",
    "groupPurchase.deadline": "Deadline",
    "groupPurchase.daysLeft": "days left",
    "groupPurchase.closed": "Closed",
    "groupPurchase.joinButton": "Join",
    "groupPurchase.viewDetails": "View Details",

    "groupPurchase.create.title": "Create Group Purchase",
    "groupPurchase.create.subtitle": "Enter location to start group purchase",
    "groupPurchase.create.location": "Location",
    "groupPurchase.create.locationPlaceholder": "e.g., Busan Haeundae",
    "groupPurchase.create.locationHelper": "Will be used as group purchase title",
    "groupPurchase.create.submit": "Create Group Purchase",
    "groupPurchase.create.success": "Group purchase created successfully",
    // Added countdown timer translations for English
    "groupPurchase.timeRemaining": "Time Remaining",
    "groupPurchase.days": "Days",
    "groupPurchase.hours": "Hours",
    "groupPurchase.minutes": "Min",
    "groupPurchase.seconds": "Sec",

    "groupPurchase.detail.title": "Group Purchase Details",
    "groupPurchase.detail.location": "Location", // Added location translation for detail page
    "groupPurchase.detail.selectOptions": "Select Options",
    "groupPurchase.detail.selectedItems": "Selected Items",
    "groupPurchase.detail.addToCart": "Add",
    "groupPurchase.detail.remove": "Remove",
    "groupPurchase.detail.personalInfo": "Personal Information",
    "groupPurchase.detail.name": "Name",
    "groupPurchase.detail.phone": "Phone",
    "groupPurchase.detail.email": "Email",
    "groupPurchase.detail.detailedAddress": "Detailed Address",
    "groupPurchase.detail.addressPlaceholder": "Enter delivery and installation address",
    "groupPurchase.detail.privacyAgree": "Agree to Privacy Policy",
    "groupPurchase.detail.submitApplication": "Submit",
    "groupPurchase.detail.applicationSuccess": "Application submitted successfully",
    "groupPurchase.detail.backToList": "Back to List",
    "groupPurchase.detail.cancel": "Cancel",
  ...
  ja: {
    ...
    "nav.projects": "施工事例",
    "nav.quote": "見積依頼",
    "nav.groupPurchase": "共同購入", // 공동구매 일본어 번역
    ...
    "hero.subtext": "無料出張見積もり · 迅速な施工 · 合理的な見積もり",
    ...
    "products.pallet.feature2": "多様な高さと幅の調節可能",
    "products.pallet.feature3": "フォークリフトを利用した迅速な入出庫",
    "products.pallet.feature4": "堅牢な構造で安全性確保",
    "products.pallet.application1": "物流センター及び配送センター",
    "products.pallet.application2": "製造業原材料保管",
    "products.pallet.application3": "大型流通業倉庫",
    ...
    "products.pallet.features.feature1.description":
      "水平面積の制約を克服し、垂直空間を活用して保管密度を最大化します。重量資材や大型製品の層層保管が可能で、単位面積あたりの保管量が大幅に向上します。倉庫設計時にラックの断面荷重、補強構造、通路幅設計などを最適化することで、劇的な効率性だけでなく、賃貸料削減、設備費用対比保管効率上昇という直接的な経済効果も得られます。",
    ...
    "products.pallet.features.feature3.description":
      "定位置保管体系を提供し、倉庫管理システム、コンピュータ管理システムなどと連動しやすくなります。ラック単位で製品位置、数量、ロット番号を管理でき、リアルタイム在庫可視性が確保されます。",
    "products.pallet.features.feature4.title": "4. 安全性確保及び商品保護（Safety & Product Protection）",
    "products.pallet.features.feature4.description":
      "産業安全基準に合わせた構造物で、積載荷重と変形許容値を明確に設計します。高強度鋼材と標準化された溶接ボルト組立方式を使用して構造的安定性を確保します。振動、衝撃、湿気などの環境要因から製品を保護し、物流損失率を減少させます。",

    // Mezzanine Rack Details
    "products.mezzanine.feature1": "垂直空間を活用した2階構造",
    "products.mezzanine.feature2": "既存倉庫面積の2倍活用",
    "products.mezzanine.feature3": "階段及び安全手すり設置",
    "products.mezzanine.feature4": "カスタム設計可能",
    ...
    "products.light.feature3": "多様なサイズ選択可能",
    ...
    "products.light.purpose.description":
      "軽量ラックは小型資材及び軽量商品保管、作業効率向上、空間活用最大化、在庫管理簡素化という利点があります。低コスト、高活用性、簡便設置が可能で、小/大規模商業空間で広く活用されています。",
    "products.light.features.title": "特徴",
    "products.light.features.feature1.title": "1. 軽量構造（Load Capacity 50~150kg/段基準）",
    "products.light.features.feature1.description": "薄い鋼材とボルト/ナット締結式構造で組立・移動が簡便です。",
    "products.light.features.feature2.title": "2. 高さ・段間隔調節可能",
    "products.light.features.feature2.description": "棚高さを自由に変更でき、様々なサイズの商品積載に柔軟です。",
    "products.light.features.feature3.title": "3. 経済性優秀",
    "products.light.features.feature3.description":
      "製作費用が低く、メンテナンスがほとんどないため、低コスト高効率設備として分類されます。",
    "products.light.features.feature4.title": "4. 組立及び拡張性",
    "products.light.features.feature4.description":
      "ボルト締結式またはスライド挿入式で構成され、組立が速く拡張・移動が容易です。",
    "products.light.features.feature5.title": "5. 多様な用途",
    "products.light.features.feature5.description":
      "オフィス：文書保管台、ボックス棚 / 倉庫：小型部品、梱包材保管 / 店舗：陳列及び在庫棚",

    // Heavy Duty Rack Details
    "products.heavy.feature1": "重量物保管のための堅牢な構造",
    "products.heavy.feature2": "高い耐荷重設計",
    "products.heavy.feature3": "産業用鋼鉄素材",
    "products.heavy.feature4": "安全認証取得",
    "products.heavy.application1": "製造業重量部品保管",
    "products.heavy.application2": "建設資材倉庫",
    "products.heavy.application3": "機械部品保管",
    "products.heavy.benefit1": "高い安全性",
    "products.heavy.benefit2": "長期間耐久性",
    "products.heavy.benefit3": "大容量保管",
    "products.heavy.purpose.title": "使用目的",
    "products.heavy.purpose.description":
      "重量ラックは段あたり300kg以上の荷重に耐え、鉄製部品、産業資材などを安全に積載可能です。構造的にパレットラックより単純ですが強度が高く、大型倉庫や工場内部保管台として活用されます。",
    "products.heavy.features.title": "特徴",
    "products.heavy.features.feature1.title": "1. 高荷重構造（Load Capacity 300kg/段以上）",
    "products.heavy.features.feature1.description": "厚いH形ビームを使用し、重量物変形なしに安定的支持が可能です。",
    "products.heavy.features.feature2.title": "2. 段間隔及び 폭 조절 가능",
    "products.heavy.features.feature2.description":
      "ビーム高さと棚間隔を現場状況に合わせて調整でき、様々な規格資材積載に適しています。",
    "products.heavy.features.feature3.title": "3. 組立式構造",
    "products.heavy.features.feature3.description":
      "ボルト締結またはフック式ビームで構成され、移動・解体・拡張が容易です。",
    "products.heavy.features.feature4.title": "4. 耐久性及び安全性強化",
    "products.heavy.features.feature4.description":
      "粉体塗装または亜鉛めっき処理で腐食防止及び長寿命保証が可能です。必要時、安全ピン、ガード、バックネットなどの付属装置を追加して作業者安全を確保します。",
    "products.heavy.features.feature5.title": "5. 適用分野多様",
    "products.heavy.features.feature5.description":
      "製造工場：半製品、金型、工具保管 / 物流倉庫：大型ボックス/製品保管 / 大型マート/流通センター：在庫保管台",

    // Sliding Rack Details
    "products.sliding.feature1": "ローラーレール構造でボックスが自動スライディング移動",
    "products.sliding.feature2": "傾斜したレール角度により先入先出（FIFO）実現",
    "products.sliding.feature3": "別途電源なしで作動する無動力システム",
    "products.sliding.feature4": "商品重量と形態に合わせたカスタム設計可能",
    "products.sliding.application1": "物流センター出荷待機所",
    "products.sliding.application2": "ピッキング及び梱包ライン",
    "products.sliding.application3": "冷蔵・冷凍倉庫の先入先出保管",
    "products.sliding.benefit1": "作業動線短縮、回転率向上",
    "products.sliding.benefit2": "空間効率及び在庫管理最適化",
    "products.sliding.benefit3": "単純な構造でメンテナンスが容易",

    // Cantilever Rack Details
    "products.cantilever.feature1": "長い資材保管に最適化",
    "products.cantilever.feature2": "前面開放型構造",
    "products.cantilever.feature3": "調節可能なアーム高さ",
    "products.cantilever.feature4": "クレーン作業容易",
    "products.cantilever.application1": "木材及びパイプ保管",
    "products.cantilever.application2": "鋼鉄資材倉庫",
    "products.cantilever.application3": "建築資材保管",
    "products.cantilever.benefit1": "長い資材保管最適化",
    "products.cantilever.benefit2": "入出庫作業便利",
    ...
    "projects.backToList": "設置事例リストへ",
    "projects.projectImages": "プロジェクト画像",
    "projects.projectOverview": "プロジェクト概要",
    "projects.detailedContent": "詳細内容",
    "projects.notFound": "プロジェクトが見つかりません",
    "projects.similarProject": "同様のプロジェクトをご希望ですか？",
    "projects.ctaDescription": "全国どこでも迅速に施工、JAEDOTECHが一緒にいます。",
    "projects.freeQuote": "無料見積もり依頼",
    ...
    "quote.delete": "削除",
    "quote.vatDisclaimer": "VAT込み / 送料・設置費別途",
    "quote.currency": "円",
    ...
    "quote.level.8": "8段",
    "quote.level.9": "9段",
    "quote.type.standalone": "独立型",
    "quote.type.connected": "連結型",
    ...
    "groupPurchase.title": "軽量ラック共同購入",
    "groupPurchase.subtitle": "一緒に購入하고 더 저렴하게",
    "groupPurchase.description": "100%国産鉄材、頑丈でクリーンな軽量ラック",
    "groupPurchase.subtitle2": "一緒に購入すればもっとお得",
    "groupPurchase.createButton": "共同購入を作成",
    "groupPurchase.listTitle": "進行中の共同購入",
    "groupPurchase.activeListTitle": "進行中の共同購入",
    "groupPurchase.closedListTitle": "終了した共同購入",
    "groupPurchase.noItems": "進行中の共同購入がありません",
    "groupPurchase.noClosedItems": "終了した共同購入がありません",
    "groupPurchase.participants": "参加者",
    "groupPurchase.deadline": "締切日",
    "groupPurchase.daysLeft": "日残り",
    "groupPurchase.closed": "終了",
    "groupPurchase.joinButton": "参加する",
    "groupPurchase.viewDetails": "詳細を見る",

    "groupPurchase.create.title": "共同購入を作成",
    "groupPurchase.create.subtitle": "場所を入力して共同購入を開始",
    "groupPurchase.create.location": "場所",
    "groupPurchase.create.locationPlaceholder": "例：釜山 海雲台",
    "groupPurchase.create.locationHelper": "共同購入のタイトルとして使用されます",
    "groupPurchase.create.submit": "共同購入を作成",
    "groupPurchase.create.success": "共同購入が作成されました",
    // Added countdown timer translations for Japanese
    "groupPurchase.timeRemaining": "残り時間",
    "groupPurchase.days": "日",
    "groupPurchase.hours": "時間",
    "groupPurchase.minutes": "分",
    "groupPurchase.seconds": "秒",

    "groupPurchase.detail.title": "共同購入の詳細",
    "groupPurchase.detail.location": "場所", // Added location translation for detail page
    "groupPurchase.detail.selectOptions": "オプション選択",
    "groupPurchase.detail.selectedItems": "選択した項目",
    "groupPurchase.detail.addToCart": "追加",
    "groupPurchase.detail.remove": "削除",
    "groupPurchase.detail.personalInfo": "個人情報入力",
    "groupPurchase.detail.name": "名前",
    "groupPurchase.detail.phone": "電話番号",
    "groupPurchase.detail.email": "メール",
    "groupPurchase.detail.detailedAddress": "詳細住所",
    "groupPurchase.detail.addressPlaceholder": "配送および設置住所を入力してください",
    "groupPurchase.detail.privacyAgree": "個人情報提供同意",
    "groupPurchase.detail.submitApplication": "申請する",
    "groupPurchase.detail.applicationSuccess": "申請が完了しました",
    "groupPurchase.detail.backToList": "リストに戻る",
    "groupPurchase.detail.cancel": "キャンセル",
