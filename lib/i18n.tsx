...
const translations: Record<Language, Record<string, string>> = {
  ...
  ja: {
    ...
    "products.pallet.purpose.title": "使用目的",
    "products.pallet.purpose.description":
      "パレットラックは単なる「棚」ではなく、空間設計、作業効率、情報管理、安全性を統合的に改善する物流インフラの中核設備です。企業の物流費削減、生産性向上、在庫精度向上に直接的な影響を与えます。",
    "products.pallet.features.title": "特徴",
    "products.pallet.features.feature1.title": "1. 空間効率の最大化 (Space Optimization)",
    "products.pallet.features.feature1.description":
      "水平面積の制約を克服し、垂直空間を活用して保管密度を最大化します。重量資材や大型製品の層別積載が可能で、単位面積当たりの保管量が大幅に向上します。倉庫設計時にラックの断面荷重、補強構造、通路幅設計などを最適化することで、劇的な効率性を実現するだけでなく、賃料削減、設備費用対保管効率の上昇という直接的な経済効果も得られます。",
    "products.pallet.features.feature2.title": "2. 物流作業効率の向上 (Operational Efficiency)",
    "products.pallet.features.feature2.description":
      "入出庫動線の短縮と作業速度の均一化が可能です。ピッキング及び積載作業動線の最小化、人力依存度の減少、作業標準化につながります。",
    "products.pallet.features.feature3.title": "3. 在庫管理の体系化 (Inventory Control)",
    "products.pallet.features.feature3.description":
      "定位置保管体系を提供し、倉庫管理システム、電算管理システムなどとの連動が容易です。ラック単位で製品位置、数量、ロット番号を管理でき、リアルタイムの在庫可視性が確保されます。",
    "products.pallet.features.feature4.title": "4. 安全性確保及び商品保護 (Safety & Product Protection)",
    "products.pallet.features.feature4.description":
      "産業安全基準に適合した構造物で、積載荷重と変形許容値を明確に設計します。高強度鋼材と標準化된 溶接ボルト組立方式を使用して構造的安定性を確保します。振動、衝撃、湿気などの環境要因から製品を保護し、物流損失率を減少させます。",
    ...
    "products.light.purpose.title": "使用目的",
    "products.light.purpose.description":
      "軽量ラックは、小型部品や軽量商品の保管、作業効率の向上、空間利用の最大化、在庫管理の単純化などの利点があります。低コスト、高効率性、簡単な設置が可能で、小規模から大規模な商業空間で広く利用されています。",
    "products.light.features.title": "特徴",
    "products.light.features.feature1.title": "1. 軽量構造 (負荷能力 50~150kg/段基準)",
    "products.light.features.feature1.description": "薄い鋼材とボルト/ネッティング方式の構造で、組立と移動が簡単です。",
    "products.light.features.feature2.title": "2. 高さと段間隔の調整可能",
    "products.light.features.feature2.description":
      "棚の高さを自由に変更できるため、様々なサイズの商品の保管に柔軟です。",
    "products.light.features.feature3.title": "3. 経済性優れ",
    "products.light.features.feature3.description":
      "製造コストが低くメンテナンスがほとんど不要で、低コスト高効率の設備として分類されます。",
    "products.light.features.feature4.title": "4. 組立と拡張性",
    "products.light.features.feature4.description":
      "ボルト組立またはスライドイン方式で構成されており、組立が速く拡張・移動が容易です。",
    "products.light.features.feature5.title": "5. 多様な用途",
    "products.light.features.feature5.description":
      "オフィス: ドキュメント保管棚、ボックス棚 / 倉庫: 小型部品、包装物の保管 / 店舗: 表示棚及び在庫棚",
    ...
    "products.heavy.application1": "製造工場の重量部品保管",
    ...
    "products.heavy.purpose.title": "使用目的",
    "products.heavy.purpose.description":
      "重量ラックは、段当たり300kg以上の負荷を耐え、鋼材部品や産業資材などを安全に保管できます。構造的にパレットラックよりも単純ですが、強度が高く大型倉庫や工場内の保管エリアで広く利用されています。",
    "products.heavy.features.title": "特徴",
    "products.heavy.features.feature1.title": "1. 高負荷構造 (負荷能力300kg/段以上)",
    "products.heavy.features.feature1.description": "厚いH型ビームを使用し、重量物の変形なく安定した支えが可能です。",
    "products.heavy.features.feature2.title": "2. 段間隔と幅の調整可能",
    "products.heavy.features.feature2.description":
      "ビームの高さと棚の間隔を現場状況に合わせて調整可能で、様々な規格の資材の保管に適しています。",
    "products.heavy.features.feature3.title": "3. 組立構造",
    "products.heavy.features.feature3.description":
      "ボルト組立または組み合わせビームで構成されており、移動・解体・拡張が容易です。",
    "products.heavy.features.feature4.title": "4. 耐久性と安全性の強化",
    "products.heavy.features.feature4.description":
      "分体処理や銅処理が可能な構造で、食害防止と長寿命を確保できます。必要に応じて安全ピン、ガード、バックネットなどの付属品を追加して作業者の安全性を確保できます。",
    "products.heavy.features.feature5.title": "5. 適用分野の多様性",
    "products.heavy.features.feature5.description":
      "製造工場: 半成品、金形、工具の保管 / 物流倉庫: 大型ボックス/製品の保管 / 大型スーパーマーケット/流通センター: 在庫保管棚",
