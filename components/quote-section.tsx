    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-3xl mx-auto">
          <div
            className={`bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12 transition-all duration-1000 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            <form className="space-y-6" onClick={handleFormInteraction}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    name="company"
                    readOnly
                    className="w-full px-0 py-2 bg-transparent border-0 border-b-2 border-gray-300 focus:border-[#0055A6] focus:outline-none transition-colors text-gray-900 cursor-pointer"
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  readOnly
                  className="w-full px-0 py-2 bg-transparent border-0 border-b-2 border-gray-300 focus:border-[#0055A6] focus:outline-none transition-colors resize-none text-gray-900 cursor-pointer"
              ...
              <div>
                ...
                <div className="relative">
                  <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors cursor-pointer text-gray-700 border-2 border-gray-300">
                    <UploadIcon />
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <button
                  type="button"
                  className="group flex items-center justify-center gap-2 px-8 py-3 bg-[#0055A6] text-white rounded-lg hover:bg-[#004494] transition-all duration-300 hover:shadow-lg md:w-auto w-full font-semibold text-base"
                >
                  <span>전송하기</span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
