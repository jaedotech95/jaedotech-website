        ...
        <div className="backdrop-blur-sm relative">
          ...
          <div className="container mx-auto px-4 relative">
            <div className="grid grid-cols-[auto_1fr_auto] md:grid-cols-3 items-center gap-4 h-16 md:h-20">
              ...
              >
                <div className="w-8 h-8 md:w-10 md:h-10 bg-white rounded-lg flex items-center justify-center shadow-lg transform transition-transform hover:scale-110">
                  <span className="font-bold text-sm md:text-base" style={{ color: "#0055A6" }}>
                    JD
                  </span>
                </div>
                <span className="font-bold text-base md:text-xl text-white">{t("hero.company")}</span>
              </Link>
