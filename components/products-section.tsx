...
export function ProductsSection() {
  ...
  const getItemStyle = (index: number) => {
    ...
    let radius = 200 // 모바일 기본값을 150에서 200으로 증가
  ...
  return (
    <section
      id="products"
      ref={sectionRef}
      className="pt-5 pb-0 md:py-24 lg:py-28 bg-background relative overflow-hidden flex items-center scrollbar-hide"
    >
          ...
          {!isListView ? (
            ...
            >
              ...
              <div className="absolute bottom-8 md:bottom-12 lg:bottom-16 left-1/2 -translate-x-1/2 pointer-events-none">
                ...
                >
                  <div
                    className="relative bg-white/95 backdrop-blur-sm rounded-md shadow-[0_4px_12px_rgba(0,85,166,0.25)] hover:shadow-[0_6px_16px_rgba(0,85,166,0.35)] transition-all duration-300 cursor-pointer border border-[#0055A6]/20 hover:border-[#0055A6]/40 pointer-events-auto"
