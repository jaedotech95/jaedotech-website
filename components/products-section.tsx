...
const productKeys = ["pallet", "light", "heavy", "drivein", "pushback", "cantilever"]
  ...
  return (
    ...
    >
      ...
      {isModalOpen && selectedProduct && (
        ...
        >
          <div
            className="relative bg-white rounded-lg shadow-[0_25px_80px_rgba(0,0,0,0.35),0_10px_30px_rgba(0,85,166,0.15)] max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Close button */}
            <button
              onClick={closeModal}
              className="absolute top-3 right-3 md:top-4 md:right-4 w-8 h-8 md:w-10 md:h-10 flex items-center justify-center rounded-full bg-[#0055A6] text-white hover:bg-[#003d7a] transition-all duration-300 hover:rotate-90 hover:scale-110 hover:ring-4 hover:ring-[#0055A6]/30 active:scale-95"
