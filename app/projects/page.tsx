          ...
          <div className="max-w-7xl mx-auto">
            ...
            {loading ? (
              ...
              <>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6">
                    {currentProjects.map((project, index) => {
                      const localizedTitle =
                        currentLanguage === "en" && project.title_en
                          ? project.title_en
                          : currentLanguage === "ja" && project.title_ja
                            ? project.title_ja
                            : project.title

                      const localizedDescription =
                        currentLanguage === "en" && project.description_en
                          ? project.description_en
                          : currentLanguage === "ja" && project.description_ja
                            ? project.description_ja
                            : project.description

                      const localizedDetails =
                        currentLanguage === "en" && project.details_en
                          ? project.details_en
                          : currentLanguage === "ja" && project.details_ja
                            ? project.details_ja
                            : project.details
                ...
                {/* Pagination */}
                {totalPages > 1 && (
                  <div className="flex justify-center items-center gap-1 md:gap-2 flex-wrap mt-12">
                    <button
                      onClick={() => handlePageChange(currentPage - 1)}
                      disabled={currentPage === 1}
                      className="px-2 md:px-3 py-2 rounded-lg border border-gray-300 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm"
