...
export default function QuotePage() {
  ...
  const breadcrumbItems = [
    ...
    { name: "견적문의", url: "https://jaedotech.com/quote" },
  ]
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-3">
                          ...
                          <SpecTooltip
                            ...
                            imageSrc={
                              currentProduct === "pallet" ? "/images/pallet-width.png" : "/images/weight-width.png"
                            }
                          />
                        </label>
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-3">
                          ...
                          <SpecTooltip
                            ...
                            imageSrc={
                              currentProduct === "pallet" ? "/images/pallet-depth.png" : "/images/weight-depth.png"
                            }
                          />
                        </label>
                        <div className="flex flex-wrap gap-1.5 md:gap-2">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-3">
                          ...
                          <SpecTooltip
                            ...
                            imageSrc={
                              currentProduct === "pallet" ? "/images/pallet-height.png" : "/images/weight-height.png"
                            }
                          />
                        </label>
                        <div className="flex flex-wrap gap-1.5 md:gap-2">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-3">
                          ...
                          <SpecTooltip
                            ...
                            imageSrc={
                              currentProduct === "pallet" ? "/images/pallet-shelf.png" : "/images/weight-shelf.png"
                            }
                          />
                        </label>
                        <div className="flex flex-wrap gap-1.5 md:gap-2">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-3">
                          ...
                          <SpecTooltip
                            ...
                            imageSrc={
                              currentProduct === "pallet" ? "/images/pallet-type.png" : "/images/weight-type.png"
                            }
                          />
                        </label>
                        <div className="flex flex-wrap gap-1.5 md:gap-2">
