  ...
  return (
    <main className="min-h-screen">
      ...
      <section
        ...
        className={`pt-28 pb-6 md:pt-36 md:pb-8 bg-gradient-to-b from-blue-50/50 to-white transition-all duration-1000 ${
            ...
            >
              <div className="mb-10 pb-8 border-b-2 border-gray-100">
                <button
                  ...
                  className="w-full flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-blue-100 hover:from-blue-100 hover:to-blue-200 rounded-lg transition-all duration-300 group border-l-4 border-[#0055A6]"
                >
                  ...
                  {selectedProducts.length > 0 && (
                    <div className="mt-6">
                        ...
                        <table className="w-full text-sm">
                          <thead>
                            <tr className="bg-gradient-to-r from-[#0055A6] to-[#0066CC] text-white">
                              <th className="px-4 py-3 text-xs font-bold">NO</th>
                              ...
                              <th className="px-4 py-3 text-right text-xs font-bold">{t("quote.unitPrice")} (원)</th>
                              <th className="px-4 py-3 text-right text-xs font-bold">{t("quote.amount")} (원)</th>
                              <th className="px-4 py-3 text-right text-xs font-bold">{t("quote.vat")} (원)</th>
                          ...
                          <tbody className="bg-white">
                            ...
                            <tr className="bg-gradient-to-r from-[#0055A6] to-[#0066CC] text-white font-bold">
                              <td colSpan={5}></td>
                              <td className="px-4 py-4 text-right text-sm">{t("quote.finalAmount")}</td>
                              <td colSpan={2} className="px-4 py-4 text-right text-lg">
                                {formatCurrency(calculateGrandTotal())}원
                              </td>
                            </tr>
                          </tbody>
                        </table>
                      ...
                      <p className="text-xs text-gray-500 mt-3 text-right font-medium">
                        <span className="text-[#0055A6] font-bold">VAT</span> 포함 /{" "}
                        <span className="text-red-600 font-bold">배송비, 설치비</span> 별도
                      </p>
                    </div>
                  )}
                </div>
              ...
              <form className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <button
                    ...
                    disabled={isSending}
                    className="group flex items-center justify-center gap-2 px-8 py-3 bg-[#0055A6] text-white rounded-lg hover:bg-[#004494] transition-all duration-300 hover:shadow-lg md:w-auto w-full font-semibold text-base disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {isSending ? (
                      ...
                      <>
                        ...
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="w-5 h-5 group-hover:animate-[slideRight_0.8s_ease-in-out_infinite]"
                        >
                          <path d="M5 12h14" />
