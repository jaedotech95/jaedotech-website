...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      {
        url: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/favicon.ico-nEaz2Z6tPn9txNlLhIVhvlWAW85KX0.x-icon",
        sizes: "any",
      },
      {
        url: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/logo-QRiMGewbHwxeGlcAgx7QQuezSwMfu9.png",
    ...
    shortcut:
      "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/favicon.ico-nEaz2Z6tPn9txNlLhIVhvlWAW85KX0.x-icon",
  },
    generator: 'v0.app'
}
