        ...
        <section ref={details.elementRef as React.RefObject<HTMLElement>} className="py-12 md:py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto space-y-16 md:space-y-24">
              ...
              >
                <h2 className="text-2xl md:text-3xl font-bold mb-6 text-center" style={{ color: "#0055A6" }}>
              ...
              >
                <h2 className="text-2xl md:text-3xl font-bold mb-12 text-center" style={{ color: "#0055A6" }}>
              ...
              {(selectedProduct === "pallet"
                ...
                // Pallet: starts with image right (index 0 = right)
                // Light: starts with image left (index 0 = left)
                // Heavy: starts with image right (index 0 = right)
                ...
                return (
                  ...
                  >
                    <div className={`grid md:grid-cols-2 gap-8 md:gap-12 items-center`}>
                      {/* Image */}
                      <div
                        className={`aspect-[4/3] bg-gray-100 rounded-2xl overflow-hidden relative shadow-lg ${
                      ...
                      <div className={isImageOnLeft ? "md:order-2" : "md:order-1"}>
                        <h3 className="text-xl md:text-2xl font-bold mb-4" style={{ color: "#0055A6" }}>
                          {feature.title}
                        </h3>
      ...
      >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">{t("products.cta.subtitle")}</p>
            <Link
              href="/quote"
