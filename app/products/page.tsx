...
export default function ProductsPage() {
  ...
  const breadcrumbItems = [
    ...
    { name: "제품소개", url: "https://jaedotech.com/products" },
  ]
  ...
  > = {
    ...
    light: {
      ...
      image: "/images/light-weight-1.png",
      features: [
    ...
    heavy: {
      ...
      image: "/images/heavy-weight.jpeg",
      features: [
